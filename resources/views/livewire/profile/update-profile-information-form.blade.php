...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
        ...
        <!-- Link para configurações de IA -->
        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            <div>
                <h3 class="text-sm font-semibold text-gray-900 dark:text-gray-100">🤖 Configurações de IA</h3>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Gerencie seus AI providers, modelos, chaves de API e persona do bot comentarista.</p>
            </div>
            <a href="{{ route('settings.ai') }}"
               class="shrink-0 inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 bg-white dark:bg-gray-800 border border-indigo-200 dark:border-indigo-700 rounded-lg">
                Gerenciar →
            </a>
        </div>
